...
import { MAX_SESSION_COST_USD, dayStartUtc, monthStartUtc, getDaySpendUsd, getMonthSpendUsd } from './budget'
...
export async function adminOverview(): Promise<AdminOverview> {
  ...
  return {
    ...
    // and the per-session spend ceiling -- which is a constant, not a setting --
    // ends a session well before a generous allowance is spent.
