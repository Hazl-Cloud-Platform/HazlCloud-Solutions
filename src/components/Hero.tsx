      ...
      <div className="relative z-10 flex-1 flex flex-col justify-end px-4 sm:px-6 md:px-12 pb-8 md:pb-14">
        <div className="flex flex-col md:flex-row items-end gap-8">
          <div className="flex-1 min-w-0 max-w-3xl">
            <h1
              className="text-lg sm:text-2xl md:text-3xl lg:text-4xl font-normal text-white leading-[1.12] mb-3 md:mb-4 animate-blur-fade-up hazl-hero-text whitespace-pre-line"
            ...
            <div className="flex flex-wrap items-center gap-3 sm:gap-4">
              <PrimaryButton delay={600}>Turn My MVP Into a Real Product</PrimaryButton>
